...
class ExtintionFetcher(th.Thread):
    ...
    def __init__(self, tname, sources, idx, total):
        ...
        self.idx = "[{}] ExtinctionFectcher {}/{}".format(
            self.tname, idx, total)
...
class Unred(run.Step):
    ...
    def vvv_colors(self, arr):
        ...
        c89_ah_vvv = (
            arr["c89_ah_2m"] + 0.032 * (arr["c89_aj_2m"] - arr["c89_ah_2m"]))

        c89_jk_color = (
            (arr["mag_j"] - c89_aj_vvv) - (arr["mag_k"] - c89_ak_vvv))
        c89_hk_color = (
            (arr["mag_h"] - c89_ah_vvv) - (arr["mag_k"] - c89_ak_vvv))
        c89_jh_color = (
            (arr["mag_j"] - c89_aj_vvv) - (arr["mag_h"] - c89_ah_vvv))

        n09_ak_vvv = arr["n09_ak_2m"] + 0.01 * arr["n09_ejk_2m"]
        n09_aj_vvv = arr["n09_aj_2m"] - 0.065 * arr["n09_ejk_2m"]
        n09_ah_vvv = (
            arr["n09_ah_2m"] + 0.032 * (arr["n09_aj_2m"] - arr["n09_ah_2m"]))

        n09_jk_color = (
            (arr["mag_j"] - n09_aj_vvv) - (arr["mag_k"] - n09_ak_vvv))
        n09_hk_color = (
            (arr["mag_h"] - n09_ah_vvv) - (arr["mag_k"] - n09_ak_vvv))
        n09_jh_color = (
            (arr["mag_j"] - n09_aj_vvv) - (arr["mag_h"] - n09_ah_vvv))
